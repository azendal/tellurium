        ...
        prototype : {
            ...
            assertion : function (assertion) {
                ...
                if (assertion.status === assertion.STATUS_SUCCESS) {
                    console.info(assertion.label, assertion.actual, not, assertion.invoked, ' ', (assertion.expected) ? assertion.expected : '');
                } else if (assertion.status === assertion.STATUS_FAIL) {
                    console.error(assertion.label, assertion.actual, not, assertion.invoked, ' ', (assertion.expected) ? assertion.expected : '');
                }
            }
        }
    });
